...
let db;
// establishes a connection to IndexedDB database called 'budget-tracker' and set it to version 1
...
// database interaction error event handler
request.onerror = function (event) {
  // log error here
  console.log(event.target.errorCode);
};

// Offline Actions: Upon submiting a new transaction and there's no internet connection
